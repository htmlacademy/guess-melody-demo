...
describe('Component: ArtistQuestionScreen', () => {
  ...
  it('onAnswer should called when user choose answer', () => {
    ...
    expect(onAnswer).nthCalledWith(1, mockArtist, firstAnswerData);
    expect(onAnswer).nthCalledWith(2, mockArtist, secondAnswerData);
    expect(onAnswer).nthCalledWith(3, mockArtist, thirdAnswerData);
  });
});
